								...
								<div class="rem">
									<div class="form_size">
										<div class="imput_right">
											<input type="text" id="quantity" class="form-control" name="quantity[quantity_0]" placeholder="Số lượng">
										</div>
										<div class="input_left">
											<input type="text" id="textsize" class="form-control" name="textsize[textsize_0]" placeholder="size">
										</div>
										<div>
											<i class="fa fa-times"></i>
										</div>
									</div>
									<div class="chualoi quantity_0 textsize_0">
									</div>
								</div>
							</div>
...
<!-- div.container>ul>li.homeword-item*3 -->
